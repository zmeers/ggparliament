...
us <- ggplot(us_congress_semicircle, aes(x, y, colour = party_short, type = "semicircle")) +
...
au <- ggplot(australia_horseshoe, aes(x, y, colour = party_short, type = "horseshoe")) +
  geom_parliament_seats() + 
  theme_void() +
  labs(colour = NULL, 
...
right <- ggplot(uk_17_right, aes(x, y, colour = party_short, type = "opposing_benches")) +
  geom_parliament_seats() + 
  theme_void() +
  labs(colour = NULL) +
...
left <- ggplot(uk_17_left, aes(x, y, colour = party_short, type = "opposing_benches")) +
  geom_parliament_seats() + 
  theme_void() +
  labs(colour = NULL, 
...
```{r,fig.width=4, fig.height=4}
rus <- ggplot(russia_classroom, aes(x, y, colour = party_short, type = "classroom")) +
  geom_parliament_seats() +
  theme_void() +
  labs(
    colour = NULL,
    title = "Russian Duma") +
  scale_colour_manual(
    values = russia$colour,
    limits = russia$party_short) +
  theme(legend.position = "bottom")
...
```{r,fig.width=4, fig.height=4}
rus2 <- ggplot(russia_circle, aes(x, y, colour = party_short, type = "circle")) +
  geom_parliament_seats() +
  theme_void() +
  labs(
    colour = NULL,
