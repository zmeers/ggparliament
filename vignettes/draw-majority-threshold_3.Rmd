...
uk <- ggplot(uk_data, aes(x, y, colour = party_short)) +
  ...
  geom_parliament_seats() +
  draw_majoritythreshold(n = 649, type = "opposing_benches") +
  theme_ggparliament()
...
australia1 <- parliament_data(election_data = australia,
  ...
  parl_rows = 4,
  #as we want to show the government, plot in order of governing party and by seat number
  plot_order = australia$government,
  type = "horseshoe")
