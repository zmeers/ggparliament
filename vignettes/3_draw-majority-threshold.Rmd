...
ggplot(usa_12, aes(x, y, colour = party_short, type = "semicircle")) +
...
au <-ggplot(australia1, aes(x, y, colour = party_short, type = "horseshoe")) +
  geom_parliament_seats() + 
  geom_highlight_government(government == 1) + 
...
german_parliament <- ggplot(germany, aes(x, y, colour = party_short, type = "semicircle"))+
  geom_parliament_seats()+
  geom_highlight_government(government == 1) + 
  draw_majoritythreshold(n = 355, label = FALSE) + 
  labs(colour="Party", 
